...
func (m *PulseManager) SyncToHeavy() {
	fmt.Println("PulseManager.SyncToHeavy: start")
	// TODO: save current pulse as
	if len(m.gotpulse) == 0 {
		fmt.Println("PulseManager.SyncToHeavy: write to m.gotpulse")
		m.gotpulse <- struct{}{}
	}
	fmt.Println("PulseManager.SyncToHeavy: end")
}
...
func (m *PulseManager) Start(ctx context.Context) error {
	...
	fmt.Printf("PulseManager.Start, startPN=%v\n", startPN)
